...
const data_ligen = {
  "Belgien 1. Liga": {
    ...
    "Over_2.5": "0.8197026022304833",
    "Under_2.5": "0.9460966542750929",
  ...
  "1. Bundesliga": {
    ...
    "Over_2.5": "0.8741830065359477",
    "Under_2.5": "0.9493464052287581",
  ...
  "2. Bundesliga": {
    ...
    "Over_2.5": "0.8594771241830066",
    "Under_2.5": "0.9722222222222222",
  ...
  "Premier League": {
    ...
    "Over_2.5": "0.8960526315789473",
    "Under_2.5": "0.9421052631578948",
  ...
  "England 3. Liga": {
    ...
    "Over_2.5": "0.8046218487394958",
    "Under_2.5": "0.8466386554621849",
  ...
  "Frankreich Lige 1": {
    ...
    "Over_2.5": "0.9150227617602428",
    "<2.5": "0.9180576631259484",
  ...
  "Frankreich Lige 2": {
    ...
    "Over_2.5": "0.9136363636363637",
    "Under_2.5": "0.8242424242424242",
  ...
  "Serie A": {
    ...
    A: "0.9197368421052632",
    "Over_2.5": "0.8789473684210526",
    "Under_2.5": "0.9552631578947368",
    AHH: "0.8973684210526316",
  ...
  "Serie B": {
    ...
    "Over_2.5": "0.9539473684210527",
    "Under_2.5": "0.9513157894736842",
  ...
  Eredivisie: {
    ...
    "Over_2.5": "0.8029739776951673",
    "Under_2.5": "0.9591078066914498",
  ...
  "Portugal 1. Liga": {
    ...
    "Over_2.5": "0.8986928104575164",
    "Under_2.5": "0.8937908496732027",
  ...
  "Schottland 1. Liga": {
    ...
    "Over_2.5": "0.8589743589743589",
    "Under_2.5": "0.905982905982906",
  ...
  "Spanien La Liga": {
    ...
    "Over_2.5": "0.9381578947368421",
    "Under_2.5": "0.9171052631578948",
  ...
  "Spanien 2. Liga": {
    ...
    "Over_2.5": "0.9588744588744589",
    "Under_2.5": "0.8365800865800865",
  ...
  "Türkei 1. Liga": {
    ...
    "Over_2.5": "0.7947658402203857",
    "Under_2.5": "0.9035812672176309",
...
labels.forEach((liga) => {
  console.log(data_ligen[liga].CA);
});
...
const data = {
  ...
  datasets: [
    {
      label: "CA",
      //   data: [12, 19, 3, 5, 2, 3, 20, 20, 65, 88, 90, 98, 100, 80, 90, 78, 80],
      data: selected_data,
      backgroundColor: [
        "rgba(255, 99, 132, 0.2)",
        "rgba(54, 162, 235, 0.2)",
